        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form style="width: 100%; margin: auto 10% auto 10% " method="GET" action="<?= base_url('admin/data_publikasi');?>">
                        <div class="input-group">
                            <input type="text" name="q" class="border border-primary rounded-100 form-control bg-light small" placeholder="Pencarian Source <?=$source?>" aria-label="Search" aria-describedby="basic-addon2">
